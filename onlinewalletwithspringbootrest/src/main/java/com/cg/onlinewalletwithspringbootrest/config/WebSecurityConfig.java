package com.cg.onlinewalletwithspringbootrest.config;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.csrf().disable()
				...
				.antMatchers("/authenticate", "/getRegistrationDetails","/register","/getUser","/getAccount").permitAll()
	...
	//	httpSecurity.authorizeRequests().antMatchers("/getRegistrationDetails").permitAll();
