...
<nav class="navbar navbar-light bg-light">
  <form class="form-inline" action="getApproveAccountNo" method="post">
    <input name="accountNo" class="form-control mr-sm-2" type="number" placeholder="account no" aria-label="Search">
